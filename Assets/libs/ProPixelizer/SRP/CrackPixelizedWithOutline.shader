...
Shader "ProPixelizer/SRP/CrackPixelizedWithOutline"
{
    ...
    Properties
    {
		...
		[IntRange] _PixelSize("PixelSize", Range(1, 10)) = 5
		...
		_Crack_Tex1("Crack Level 1", 2D) = ""{}
		_Crack_Tex2("Crack Level 2", 2D) = ""{}
		_Crack_Tex3("Crack Level 3", 2D) = ""{}
		_Crack_Tex4("Crack Level 4", 2D) = ""{}
		_Crack_Tex5("Crack Level 5", 2D) = ""{}
		_Crack_Tex6("Crack Level 6", 2D) = ""{}
		_Crack_Tex7("Crack Level 7", 2D) = ""{}
		_Crack_Tex8("Crack Level 8", 2D) = ""{}
		_Crack_Tex9("Crack Level 9", 2D) = ""{}
		_Crack_Tex10("Crack Level 10", 2D) = ""{}
	}
		...
		Pass
		{
			...
			float4 _Crack_Tex1_TexelSize;
			float4 _Crack_Tex1_ST;
			float4 _Crack_Tex2_TexelSize;
			float4 _Crack_Tex2_ST;
			float4 _Crack_Tex3_TexelSize;
			float4 _Crack_Tex3_ST;
			float4 _Crack_Tex4_TexelSize;
			float4 _Crack_Tex4_ST;
			float4 _Crack_Tex5_TexelSize;
			float4 _Crack_Tex5_ST;
			float4 _Crack_Tex6_TexelSize;
			float4 _Crack_Tex6_ST;
			float4 _Crack_Tex7_TexelSize;
			float4 _Crack_Tex7_ST;
			float4 _Crack_Tex8_TexelSize;
			float4 _Crack_Tex8_ST;
			float4 _Crack_Tex9_TexelSize;
			float4 _Crack_Tex9_ST;
			float4 _Crack_Tex10_TexelSize;
			float4 _Crack_Tex10_ST;
			CBUFFER_END
			...
			TEXTURE2D(_Crack_Tex1);
			TEXTURE2D(_Crack_Tex2);
			TEXTURE2D(_Crack_Tex3);
			TEXTURE2D(_Crack_Tex4);
			TEXTURE2D(_Crack_Tex5);
			TEXTURE2D(_Crack_Tex6);
			TEXTURE2D(_Crack_Tex7);
			TEXTURE2D(_Crack_Tex8);
			TEXTURE2D(_Crack_Tex9);
			TEXTURE2D(_Crack_Tex10);

			#include "CrackOutlinePass.hlsl"
			ENDHLSL
		}
     }
	CustomEditor "CrackPixelizedWithOutlineShaderGUI"
