...
{
    public class DefaultMoveable : Actorable, IMoveable
    {
        public DefaultMoveable(ActorModel actor) : base(actor)
        {
        }
        ...
        public virtual bool Move(Vector3 direction)
        {
            ...
            float speedPower = Time.deltaTime * actor.speed * IMoveable.SPEED_CONSTANT;
