...
public class CustomPostProcessPass : ScriptableRenderPass
{
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        if (customEffect.IsActive())
        {
            ...
            material.SetFloat(Shader.PropertyToID("_Dx"), customEffect.dx.value);
            material.SetFloat(Shader.PropertyToID("_Dy"), customEffect.dy.value);
            material.SetFloat(Shader.PropertyToID("_Intercept"), customEffect.intercept.value);

            material.SetFloat(Shader.PropertyToID("_Slash"), customEffect.slash.value);
            material.SetFloat(Shader.PropertyToID("_Decompose"), customEffect.decompose.value);
